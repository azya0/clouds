@tool
class_name GPUNoiseTexture3D extends Texture3DRD
...
const TEXTURE_TYPE := RenderingDevice.TEXTURE_TYPE_3D
...
##
## layout([FORMAT], set = 0, binding = 0) uniform restrict writeonly image3D noise_image;
##
